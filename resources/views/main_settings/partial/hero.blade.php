...
<h5>Video Link URL</h5>
<input type="url" name="video" class="form-control mt-3 mb-3" placeholder="Enter Video Link" value="">
...
<form method="POST" enctype="multipart/form-data" action="">
    ...
    <div class="text-center">
        <img id="previewHeroBg" class="img-thumbnail mt-3 mb-3" src="{{ asset(trans('app.wallpaper.auth')) }}"
            style="height: 200px">
